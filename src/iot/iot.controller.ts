...
export class IotController {
  ...
  updateControl(
    ...
    return this.iotService.updateControl(kitId, updateControlDto, req.user.user_id);
  }
  ...
  updateConfig(
    ...
    return this.iotService.updateConfig(kitId, updateConfigDto, req.user.user_id);
  }
