...
export function FarmerLayout() {
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fc] text-slate-800">
      ...
      <aside
        className={`fixed left-0 top-0 z-50 flex h-screen w-64 flex-col border-r border-slate-200 bg-white shadow-sm transition-transform duration-300 lg:z-auto ${
        ...
        <header className="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-slate-200 bg-white/90 px-4 backdrop-blur lg:px-6">
          <div className="flex items-center gap-3">
            ...
            <div className="hidden items-center gap-3 rounded-full border border-slate-200 bg-slate-50 px-4 py-2 text-sm text-slate-500 md:flex">
              ...
              <input
                className="w-48 border-0 bg-transparent outline-none placeholder:text-slate-400 lg:w-72"
          ...
          <div className="flex items-center gap-3">
            <StaffAlertsBell alertsPath="/farmer/notifications" />
            <Link
              to="/farmer/profile"
              title="My profile"
              className="flex h-10 w-10 items-center justify-center rounded-full bg-emerald-600 text-sm font-semibold text-white hover:bg-emerald-700"
